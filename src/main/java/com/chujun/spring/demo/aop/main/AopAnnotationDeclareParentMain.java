 ...
 */
public class AopAnnotationDeclareParentMain {
    public static void main(String[] args){
        ApplicationContext context = new ClassPathXmlApplicationContext("spring/aop/spring-aop-annotation-declareParent.xml");
        //两个表演者
